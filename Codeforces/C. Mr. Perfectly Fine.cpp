...
int main() {
    ...
    {
        int n; cin >> n;
        int mini1 = 1e9, mini2 = 1e9, mini3 = 1e9;
        for (int i = 0; i < n; i++)
        {
            int m; cin >> m;
            string s; cin >> s;
            if (s[0] == '1' && s[1] == '1') mini1 = min(mini1, m);
            else if (s[0] == '1') mini2 = min(mini2, m);
            else if (s[1] == '1') mini3 = min(mini3, m);
        }
        if (mini1 != 1e9) {
            cout << min(mini1, mini2 + mini3) << endl;
        }
        else if (mini2 != 1e9 && mini3 != 1e9)
        {
            cout << min(mini1, mini2 + mini3) << endl;
        }
        else cout << -1 << endl;
